...
execute if score @s ani.timer matches 1.. run scoreboard players set @s up.align.0 1
execute if score @s ani.timer matches 1.. run scoreboard players set @s up.align.1 0
