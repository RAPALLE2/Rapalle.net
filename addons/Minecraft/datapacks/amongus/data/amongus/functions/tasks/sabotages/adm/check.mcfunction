...
execute unless score right o2.alarm.prog matches 6 run function amongus:tasks/sabotages/adm/init
execute if score right o2.alarm.prog matches 6 run function amongus:tasks/sabotages/adm/end
