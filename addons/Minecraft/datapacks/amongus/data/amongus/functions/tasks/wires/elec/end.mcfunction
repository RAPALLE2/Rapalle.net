...
execute if score @s wireA.connected matches 1 if score @s wireB.connected matches 1 if score @s wireC.connected matches 1 if score @s wireD.connected matches 1 run scoreboard players set @s elec.wiring 1
...
execute if score @s elec.wiring matches 1 if score @s fix.wiring matches 0 run function amongus:tasks/wires/elec/new
