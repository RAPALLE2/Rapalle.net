...
execute if score @s ani.timer matches 5 run function amongus:tasks/reactor/animation/error
...
execute if score @s ani.timer matches 13 run function amongus:tasks/reactor/animation/error
...
execute if score @s ani.timer matches 20 run function amongus:tasks/reactor/animation/error
...
execute if score @s ani.timer matches 25 run function amongus:tasks/reactor/init
