...
data modify storage tasks:power indicator.0.o2 set value '{"text":"█","color":"#feff5d"}'

data modify storage tasks:power slider.0.o2 set value '{"text":"█","color":"#a50209"}'
...
data modify storage tasks:power slider.2.o2 set value '{"text":"█","color":"#3A3A3A","clickEvent":{"action":"run_command","value":"/trigger o2.power.0a set 4"}}'
...
scoreboard players set @s o2.power.0a 9
