...
data modify storage tasks:power indicator.1.sec set value '{"text":"█","color":"#000000"}'

data modify storage tasks:power slider.0.sec set value '{"text":"█","color":"#3A3A3A","clickEvent":{"action":"run_command","value":"/trigger sec.power.0a set 8"}}'
...
data modify storage tasks:power slider.4.sec set value '{"text":"█","color":"#a50209"}'

function amongus:tasks/power0/canvas

scoreboard players set @s sec.power.0a 1
