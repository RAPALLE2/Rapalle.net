...
execute if score @s failed matches 1.. run function amongus:tasks/wires/adm/end
...
execute if score @s connectorA matches 1 if score @s wireA.connected matches 1 run function amongus:tasks/wires/adm/shaft
...
execute if score @s connectorB matches 1 if score @s wireB.connected matches 1 run function amongus:tasks/wires/adm/shaft
...
execute if score @s connectorC matches 1 if score @s wireC.connected matches 1 run function amongus:tasks/wires/adm/shaft
...
execute if score @s connectorD matches 1 if score @s wireD.connected matches 1 run function amongus:tasks/wires/adm/shaft
...
execute if score @s wireA.connected matches 1 if score @s wireB.connected matches 1 if score @s wireC.connected matches 1 if score @s wireD.connected matches 1 if score tick data matches 10 run function amongus:tasks/wires/adm/end
