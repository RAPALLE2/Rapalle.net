...
execute if score @s wireA.connected matches 1 if score @s wireB.connected matches 1 if score @s wireC.connected matches 1 if score @s wireD.connected matches 1 run scoreboard players set @s caf.wiring 1
...
execute if score @s caf.wiring matches 1 if score @s fix.wiring matches 2 run scoreboard players add @s fix.wiring 1
execute if score @s caf.wiring matches 1 if score @s fix.wiring matches 1 run function amongus:tasks/wires/caf/new
