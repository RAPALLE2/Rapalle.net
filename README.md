...
<br>
#### Sources
All images are created with "Bing Co-pilot AI" and are released for use.<br>
The font "Roboto-Condensed" from "Google Fonts" is installed on the server and also released for use.<br>
