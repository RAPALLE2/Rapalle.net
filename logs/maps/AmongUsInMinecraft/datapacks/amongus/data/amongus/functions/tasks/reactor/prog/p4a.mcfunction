...
execute if score @s ani.timer matches 45 run function amongus:tasks/reactor/buttons/b1
execute if score @s ani.timer matches 45 run function amongus:tasks/reactor/canvas

execute if score @s ani.timer matches 45 run scoreboard players set @s reactor.prog 41
execute if score @s ani.timer matches 45 run scoreboard players set @s ani.timer -1
