...
execute if score @s wireA.connected matches 1 if score @s wireB.connected matches 1 if score @s wireC.connected matches 1 if score @s wireD.connected matches 1 run scoreboard players set @s sec.wiring 1

execute if score @s sec.wiring matches 1 run scoreboard players add @s fix.wiring 1
