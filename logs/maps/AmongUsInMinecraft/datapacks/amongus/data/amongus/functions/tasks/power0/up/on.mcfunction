...
data modify storage tasks:power indicator.0.up set value '{"text":"█","color":"#feff5d"}'

data modify storage tasks:power slider.0.up set value '{"text":"█","color":"#a50209"}'
...
scoreboard players set @s up.power.0a 9
