...
execute store success score bool temp if predicate amongus:rng_0_2 run scoreboard players set @s strg.wiring 0

execute unless score bool temp matches 1 store success score bool temp if predicate amongus:rng_0_375 run scoreboard players set @s adm.wiring 0
