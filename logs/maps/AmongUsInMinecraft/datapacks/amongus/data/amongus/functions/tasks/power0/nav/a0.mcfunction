...
data modify storage tasks:power indicator.1.nav set value '{"text":"█","color":"#000000"}'

data modify storage tasks:power slider.0.nav set value '{"text":"█","color":"#3A3A3A","clickEvent":{"action":"run_command","value":"/trigger nav.power.0a set 8"}}'
...
data modify storage tasks:power slider.4.nav set value '{"text":"█","color":"#a50209"}'

function amongus:tasks/power0/canvas

scoreboard players set @s nav.power.0a 1
