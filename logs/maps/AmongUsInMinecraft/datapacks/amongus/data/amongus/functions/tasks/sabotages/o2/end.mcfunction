...
execute if score right o2.alarm.prog matches 6 run scoreboard players set playerB sabotage 1
execute if score right o2.alarm.prog matches 6 run kill @e[type=minecraft:villager,limit=1,tag=o2.sab.b]
