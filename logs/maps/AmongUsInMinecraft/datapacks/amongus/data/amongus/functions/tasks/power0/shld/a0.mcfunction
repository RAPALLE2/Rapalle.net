...
data modify storage tasks:power indicator.1.shld set value '{"text":"█","color":"#000000"}'
...
data modify storage tasks:power slider.4.shld set value '{"text":"█","color":"#a50209"}'

function amongus:tasks/power0/canvas

scoreboard players set @s shld.power.0a 1
